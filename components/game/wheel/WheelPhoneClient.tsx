...
import { GAME_EVENTS, GAME_REGISTRY } from '@/lib/games/registry'
import { spinWheel } from '@/lib/actions/games/wheel/spinWheel'
import { guessLetter } from '@/lib/actions/games/wheel/guessLetter'
import { buyVowel } from '@/lib/actions/games/wheel/buyVowel'
import { solvePhrase } from '@/lib/actions/games/wheel/solvePhrase'
...
export default function WheelPhoneClient({ userId, initialGame }: Props) {
  ...
  if (!game || game.status === 'LOBBY') {
    return (
      <PhoneShell>
        <Centered>
          <p className="font-quicksand font-black text-xl mb-2">Sqywheel of Fortune</p>
