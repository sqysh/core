export const closedBusinessNotificationTemplate = (giverName: string, fullUrl: string) => {
...
<head>
  ...
  <title>Thank You from ${giverName}</title>
</head>
          ...
          <tr>
            <td style="padding: 24px 32px;">
              <p style="margin: 0 0 24px 0; color: #64748b; font-size: 14px; line-height: 1.6;">
                <strong style="color: #0c1e2e;">${giverName}</strong> has logged a thank you for closed business with you. Tap the button below to see the details.
              </p>
