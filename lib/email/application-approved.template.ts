export const memberAcceptedTemplate = (firstName: string, dashboardUrl: string) => {
...
<head>
  ...
  <title>You're In — Coastal Referral Exchange</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 500px; margin: 0 auto; background: #ffffff; border-top: 3px solid #0284c7;">
          <tr>
            <td style="padding: 28px 32px 20px;">
              ...
              <h1 style="margin: 0; color: #0c1e2e; font-size: 22px; font-weight: 800; letter-spacing: -0.02em;">You're In.</h1>
            </td>
          </tr>
          <tr>
