...
import PresenterSchedule from '../../../components/member/dashboard/PresentersSchedule'
import { MemberList } from '../../../components/member/dashboard/MemberList'
import { HistoryTabs } from '../../../components/member/dashboard/HistoryTabs'
import FadeUp from '../../../components/_shared/FadeUp'
import { SectionLabel } from '../../../components/_shared/SectionLabel'
import { Greeting } from '../../../components/member/dashboard/Greeting'
import { ActivityStats } from '../../../components/member/dashboard/ActivityStats'
import { EventButton } from '../../../components/member/dashboard/EventButton'
import { EventsList } from '../../../components/member/dashboard/EventsList'
import VisitorPanel from '../../../components/member/dashboard/VisitorPanel'
import { MemberDashboardProps } from '@/types/dashboard.types'
import { AttendancePanel } from '@/app/components/member/dashboard/AttendancePanel'
import MembershipSetupPanel from '@/app/components/member/dashboard/MembershipSetupPanel'
